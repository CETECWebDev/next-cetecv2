...
const applications = [
  {
    id: 1,
    icon: <FaWarehouse className="w-10 h-10 text-white" />,
    title: "نمایشگاه ها",
    description: "تحلیل موفقیت کمپین‌ها و غرفه‌ها",
  },
  {
    id: 2,
    icon: <FaBus className="w-10 h-10 text-white" />,
    title: "صنعت حمل ونقل",
    description: "پایش تراکم مسافر",
  },
  {
    id: 3,
    icon: <FaLandmark className="w-10 h-10 text-white" />,
    title: "موزه ها و مراکز فرهنگی",
    description: "تحلیل اثربخشی برنامه های فرهنگی",
  },
  {
    id: 4,
    icon: <FaStore className="w-10 h-10 text-white" />,
    title: "فروشگاه‌های زنجیره‌ای",
    description: "بهینه سازی چیدمان و موجودی کالا",
  },
  {
    id: 5,
    icon: <FaPlane className="w-10 h-10 text-white" />,
    title: "فرودگاه ها",
    description: "پیش بینی ازدحام و مدیریت صف ها",
  },
  {
    id: 6,
    icon: <FaUniversity className="w-10 h-10 text-white" />,
    title: "دانشگاه ها",
    description: "پایش هوشمند و تحلیل رفتار دانشجویان",
  },
  {
    id: 7,
    icon: <FaBuilding className="w-10 h-10 text-white" />,
    title: "ادارات",
    description: "مدیریت بهتر ارباب رجوع و مراجعین",
  },
  {
    id: 8,
    icon: <FaBook className="w-10 h-10 text-white" />,
    title: "کتابخانه ها",
    description: "مدیریت بهینه فضا و منابع انسانی",
  },
];

export default function ApplicationsSlider() {
  return (
    <section className="py-16 bg-gradient-to-b from-[#f5f7fa] to-[#c3cfe2] dark:bg-gradient-to-b dark:from-[#0f2027] dark:via-[#203a43] dark:to-[#2c5364] transition-colors duration-500">
